...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AppointmentServiceImpl() {
        PathUtils.ensureFiles(
            new File(PathUtils.currentPath("data/appointments.json")),
            new File(PathUtils.currentPath("data/patient_appointments.json"))
        );
    }
    ...
    public List<Appointment> getAllAppointments() {        
        String json = PathUtils.currentPath("data/appointments.json");
    ...
    public boolean addPatientAppointment(Appointment appointment, Patient patient) {        
        ...
        File jsonFile = new File(PathUtils.currentPath("data/patient_appointments.json"));
    ...
    public List<Appointment> getPatientAppointments(int patientId) {
        File json = new File(PathUtils.currentPath("data/patient_appointments.json"));
    ...
    private boolean updateAllAppointments(List<Appointment> appointments) {
        String content = gson.toJson(appointments);
        File jsonFile = new File(PathUtils.currentPath("data/appointments.json"));
